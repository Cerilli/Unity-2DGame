...
public class PlayerBounds : MonoBehaviour
{
	...
	private BoxCollider2D _boxCollider; // We need the player's box Collider to know if the player is hitting the bounds or not
	...
	public void Update()
	{
		...
		// Get the size of the player's box collider
