...
//Name: Blocking_2.ma
//Last modified: Wed, Feb 11, 2015 08:36:40 PM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 17.307309191327249 16.545867628365688 1.3813131509543435 ;
	setAttr ".r" -type "double3" -3.3383527189621911 97.399999999938132 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 16.01848819252616;
...
createNode mesh -n "polySurfaceShape2" -p "polySurface1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 70 ".pt";
	setAttr ".pt[0]" -type "float3" 0 0.15697251 -0.041484661 ;
	setAttr ".pt[1]" -type "float3" 0 -0.0040035881 -0.12005445 ;
	setAttr ".pt[2]" -type "float3" 0 0.037879694 0.06877213 ;
	setAttr ".pt[3]" -type "float3" 0 0.2342023 0.17013872 ;
	setAttr ".pt[4]" -type "float3" 0 0.10656039 0.14992261 ;
	setAttr ".pt[5]" -type "float3" 0 0.065365016 0.034555137 ;
	setAttr ".pt[6]" -type "float3" 0 0.024743438 0.07424292 ;
	setAttr ".pt[7]" -type "float3" -1.3038516e-008 0.28755021 0.12611043 ;
	setAttr ".pt[8]" -type "float3" 0 0 -0.051616352 ;
	setAttr ".pt[9]" -type "float3" -0.047086179 0.065365016 0.014326839 ;
	setAttr ".pt[10]" -type "float3" 0 0 0.10284576 ;
	setAttr ".pt[11]" -type "float3" 0.027269546 0.19375063 -0.013057946 ;
	setAttr ".pt[12]" -type "float3" 0 0 0.063107684 ;
	setAttr ".pt[13]" -type "float3" 0 0.065365016 0.046404704 ;
	setAttr ".pt[14]" -type "float3" 0 0.090995349 -0.010144372 ;
	setAttr ".pt[15]" -type "float3" 0 0 0.014625847 ;
	setAttr ".pt[16]" -type "float3" 0 -0.015165431 0.042722918 ;
	setAttr ".pt[17]" -type "float3" 0 -0.14023055 0.11636276 ;
	setAttr ".pt[18]" -type "float3" 0 0.065365016 0.014485202 ;
	setAttr ".pt[19]" -type "float3" 0 0.090175599 -0.1919359 ;
	setAttr ".pt[20]" -type "float3" 0 0.23087879 0.063298233 ;
	...
	setAttr ".pt[27]" -type "float3" 0 0.096411325 0.17115699 ;
	setAttr ".pt[28]" -type "float3" 0 0 0.12106715 ;
	setAttr ".pt[29]" -type "float3" 0 0.22501957 0.12083302 ;
	setAttr ".pt[30]" -type "float3" 0 0.065365016 0.049423289 ;
	setAttr ".pt[31]" -type "float3" 0 0.12362486 0.043114737 ;
	setAttr ".pt[32]" -type "float3" 0 0.058006935 0.072110139 ;
	setAttr ".pt[33]" -type "float3" 0 -0.079297855 0.047888197 ;
	setAttr ".pt[34]" -type "float3" 0 0.050481044 0.052741122 ;
	setAttr ".pt[35]" -type "float3" 0 0.24258336 0.14879847 ;
	setAttr ".pt[36]" -type "float3" 0 0.052938726 0.34927613 ;
	setAttr ".pt[40]" -type "float3" 0 0 -0.16359383 ;
	setAttr ".pt[47]" -type "float3" 0 0 -0.11798245 ;
	setAttr ".pt[54]" -type "float3" 0 0 -0.13970289 ;
	setAttr ".pt[61]" -type "float3" 0 0 -0.12806098 ;
	...
	setAttr ".pt[106]" -type "float3" 0 0 -0.14534929 ;
	setAttr ".pt[107]" -type "float3" 0 0 -0.063855931 ;
	setAttr ".pt[108]" -type "float3" 0 0 -0.082100503 ;
